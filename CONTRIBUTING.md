# Contributing to SiO UI React

Thank you for considering contributing to **SiO UI React**.
...
```
packages/
   ui-core          Base componants
   ui-modal         Modal component
   ui-form          Form-specific UI
```
...
```bash
git clone https://github.com/sio-group/sio-ui-react.git
cd sio-ui-react
npm install
```
